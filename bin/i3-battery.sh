...
CRITICAL_PERCENT=5  # Sleep when battery at this level.
...
{
    i3-nagbar -t warning -m 'Battery low!' -b 'Suspend!' 'systemctl suspend' -b 'Poweroff!' 'systemctl poweroff' >/dev/null 2>&1 &
    NAGBAR_PID=$!
}
